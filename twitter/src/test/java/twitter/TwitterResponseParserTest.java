...
public class TwitterResponseParserTest {
    ...
    public void parseResponse() throws Exception {
        ...
        List<Tweet> tweets = parser.parseResponse(testResponse);

        Assert.assertEquals(4, tweets.size());

        DateFormat df = new SimpleDateFormat("EEE MMM dd kk:mm:ss ZZZ yyyy");
        Assert.assertEquals(tweets.get(0), new Tweet("Aggressive Ponytail #freebandnames", "Mon Sep 24 03:35:21 +0000 2012"));
        Assert.assertEquals(tweets.get(1), new Tweet("Thee Namaste Nerdz. #FreeBandNames", "Fri Sep 21 23:40:54 +0000 2012"));
        Assert.assertEquals(tweets.get(2), new Tweet("Mexican Heaven, Mexican Hell #freebandnames", "Fri Sep 21 23:30:20 +0000 2012"));
        Assert.assertEquals(tweets.get(3), new Tweet("The Foolish Mortals #freebandnames", "Fri Sep 21 22:51:18 +0000 2012"));
    }
}
